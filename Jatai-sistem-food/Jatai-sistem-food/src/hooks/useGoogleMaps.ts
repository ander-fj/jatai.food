...
export const useGoogleMaps = (apiKey: string = 'AIzaSyDQ_q5pURFbmjuOlvB5RNslZUr6Y6Yo_aE') => {
...
export const useGoogleMapsGeocoding = () => {
  const geocodeAddress = useCallback(async (address: string): Promise<{ lat: number, lng: number } | null> => {
    ...
    try {
      ...
      const url = `https://maps.googleapis.com/maps/api/geocode/json?address=${encoded}&key=AIzaSyDQ_q5pURFbmjuOlvB5RNslZUr6Y6Yo_aE`;
