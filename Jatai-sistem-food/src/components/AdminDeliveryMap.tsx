...
import { DELIVERY_JOKES, getQueueMessage, getRandomMessage } from '../utils/deliveryMessages';
...
export default function AdminDeliveryMap({ selectedOrderId, isTrackingPage = false, tenantId }: AdminOrdersMapProps) {
