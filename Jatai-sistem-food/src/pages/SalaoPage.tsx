...
import { Utensils, ShoppingCart, Plus, Minus, Send, User, Hash, Search, X, Share2, History, Settings } from 'lucide-react';
    ...
    return (
      <div className="flex items-center justify-center h-full bg-gray-50 p-4">
        <div className="w-full max-w-md bg-white p-8 rounded-xl shadow-lg text-center">
          <Settings className="mx-auto h-16 w-16 text-red-500 mb-6" />
          <h1 className="text-2xl font-bold text-gray-800 mb-6">O que vamos saborear!</h1>
